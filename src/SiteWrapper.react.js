...
const accountDropdownProps = {
  ...
  name: "Jane Pearson",
  description: "City of Toronto - Controller",
  options: [
    ...
    notificationsObjects: [
      {
        ...
        message: (
          <React.Fragment>
            <strong>Brampton</strong> published new coronavirus stats
          </React.Fragment>
        ),
        time: "10 minutes ago",
      },
    ...
    return (
      <Site.Wrapper
        headerProps={{
          href: "/",
          alt: "Tabler React",
          imageURL: "/controlcubelogo.jpg",
          navItems: (
            <Nav.Item type="div" className="d-none d-md-flex">
              <Button
                href="https://dmz.ryerson.ca/hack-the-curve/"
                target="_blank"
                outline
                size="sm"
                RootComponent="a"
        ...
        footerProps={{
          links: [
            <a href="https://dmz.ryerson.ca/hack-the-curve/">Hack The Curve</a>,
          ],
          note:
            "Made for the DMZ HackTheCurve Hackathon",
          copyright: (
            <React.Fragment>
              2020
            </React.Fragment>
